!v10: v2 but wit PCG for random numbers.
module Worm7Vertex_v10
    ...
    subroutine generateWormData(N0C,N1C,MC,n_data) bind(C,name="generate7VertexWormDataFortran_v10") 
    ...
    !PCG Implementation taken from https://gist.github.com/ivan-pi/060e38d5f9a86c57923a61fbf18d095c (22.02.2026)
    ...
    function randomint(a,b) !Random Integer between and including a and b.
	    ...
	    integer :: randomint
	    randomint = MODULO( pcg32_random(), b-a+1) + a
	
    end function randomint
    
end module Worm7Vertex_v10