!v4: Same as v1, but "cleaned up" a bit: Lattice is initialized without using 3 loops, unused variables and subroutines are removed, intent is specified.
!Furthermore, calculating the number of bonds, the entire proposed lattice and if the lattice is valid was removed.
module Worm7Vertex_v4
    ...
    subroutine generateWormData(N0,N1,M,n_data) bind(C,name="generate7VertexWormDataFortran_v4") 
