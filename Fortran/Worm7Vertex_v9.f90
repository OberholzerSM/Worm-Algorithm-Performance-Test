!v9: v2 but with the lattice being passed.
module Worm7Vertex_v9
    ...
    subroutine generateWormData(N0C,N1C,MC,n_data) bind(C,name="generate7VertexWormDataFortran_v9") 
        ...
        integer, dimension(N0C,N1C,4) :: lattice                !Lattice of vertices.
