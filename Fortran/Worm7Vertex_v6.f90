!v6: Same as v5, but array-slices are not used as subroutine and function inputs, q2/q1 removed for the start. Slight improvment at determining weightx_new
module Worm7Vertex_v6
    ...
    subroutine generateWormData(N0,N1,M,n_data) bind(C,name="generate7VertexWormDataFortran_v6") 
	...
	subroutine Worm(N0,N1,M,lattice)
		...
		check_end = 1
        oldvertex_x = lattice(start0,start1,:)
